...
try {
    ...
    if($pdo)
    {
        ...
        $length = sizeof($data);
        //echo $length;
?><form action="bt_reserve.php" method="post"><?php
        foreach ($data as $key => $value)
        {
            ...
            }?><input type="radio" name = "key" value="<?php echo $key;?>"> </div><?php
        }?>
        <input type="submit" value="예약하기" style="float: left; clear: both;"></form><?php
    }
    else{
        echo "fail";
    }
